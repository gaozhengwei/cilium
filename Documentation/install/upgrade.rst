...
~~~~~~~~~~~~~~~~~~~~~
  ...
  * ``mapDynamicSizeRatio`` has been added to allow dynamic sizing of the
    ...
    map sizes configured manually using the ``ctTcpMax``, ``ctAnyMax``,
    ``natMax`` or ``neighMax`` options will take precedence over the dynamically
    determined value.
